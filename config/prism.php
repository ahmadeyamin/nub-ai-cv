...
return [
    'prism_server' => [
        ...
        'default' => env('PRISM_PROVIDER', 'gemini'),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may define the configuration for each provider that you want
    | to use. You may check the documentation for each provider to see
